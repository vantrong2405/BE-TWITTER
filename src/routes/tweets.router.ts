...
import { createTweetController, deleteTweetController, getNewfeedsController, getTweetChildrenController, getTweetController } from '~/controllers/tweets.controllers'
...
TweetRouter.delete('/:tweet_id', accessTokenValidator, verifiedUserValidator, tweetIDValidator, wrapRequestHandler(deleteTweetController)
